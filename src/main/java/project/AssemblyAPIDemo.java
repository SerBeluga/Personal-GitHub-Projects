...
public class AssemblyAPIDemo {
    ...
    public static void main(String[] args) throws Exception { 
        ...
        String DEATH = null; //TODO: Placeholder replace with theoden-plennenor-fields soundbyte
        ...
        Transcript audioClip = new Transcript(); 
        audioClip.setAudio_url(maximius);
        Gson gson = new Gson(); 
        String jsonMaximus = gson.toJson(audioClip); 
        ...
        HttpResponse<String> postResp = httpClient.send(postReq, BodyHandlers.ofString());
